...
def _svg_speed_chart(
    methods: list[str], times_data: list[list[float]], colors: list[str], title: str
) -> str:
...
def _svg_radar_chart(labels: list[str], series: list[list[float]], title: str) -> str:
...
def _svg_compare_bar(labels: list[str], values: list[float], title: str, ylabel: str) -> str:
...
def _smooth(ys: list[float], window: int = 5) -> list[float]:
...
def _safe(metrics: dict[str, Any], key: str, fmt: str = ".4f") -> str:
...
class PaperInjector:
    ...
    def _load_all_experiments(self) -> dict[str, Any]:
...
def print_table1_dataset_stats(actual_counts: dict[str, int] | None = None) -> None:
...
def print_table2_experiments(all_exp: dict[str, Any]) -> None:
...
def print_table3_perfield(all_exp: dict[str, Any]) -> None:
...
def print_table4_leaderboard(all_exp: dict[str, Any]) -> None:
...
def print_table5_trocr_yolo(trocr_exp: dict[str, Any]) -> None:
...
def print_table6_cross_architecture(donut_exp: dict[str, Any], trocr_exp: dict[str, Any]) -> None:
...
def build_var_map(all_exp: dict[str, Any]) -> dict[str, str]:
...
def fill_paper(
    paper_path: str, output_path: str, var_map: dict[str, str], strict: bool = False
) -> None:
...
def compute_diff(old_text: str, new_text: str) -> list[dict[str, Any]]:
